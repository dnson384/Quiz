...
export default function TermCard({ term, definition }: TermData) {
  return (
    <div className="flex items-center gap-2 h-fit p-4 rounded-md bg-white">
      {/* Term */}
      <div className="w-[30%]">
      ...
      {/* Star icon */}
      <div
        className="p-2 rounded-full cursor-pointer select-none hover:bg-gray-200"
